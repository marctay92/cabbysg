...
import com.example.android.cabbysg.nav_driverprofile;
 ...
 */
public class driverEditPassword extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView= inflater.inflate(R.layout.fragment_driver_edit_password, container, false);
        currentPasswordText= rootView.findViewById(R.id.dcurrentPassword);
        newPasswordText= rootView.findViewById(R.id.dnewPassword);
        reEnterText= rootView.findViewById(R.id.dreEnter);
        submitBtn= rootView.findViewById(R.id.dconfirmChange);
                                                ...
                                                .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                    ...
                                                    public void onComplete(@NonNull Task<Void> task) {
                                                        if (task.isSuccessful()) {
                                                            ...
                                                            transaction.replace(R.id.driverEditPassword,newFragment);
