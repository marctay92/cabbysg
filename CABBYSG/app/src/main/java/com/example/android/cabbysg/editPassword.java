 ...
 * {@link editPassword.OnFragmentInteractionListener} interface
...
public class editPassword extends Fragment {
    ...
    public static editPassword newInstance(String param1, String param2) {
        editPassword fragment = new editPassword();
