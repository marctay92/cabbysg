...
public class driverschedule_details {
    ...
    public String driverschedule_time;
    ...
    public driverschedule_details(String driverschedule_id,String driverschedule_date, String driverschedule_time, String driverschedule_riderID,
        ...
        this.driverschedule_time = driverschedule_time;
